...
internal sealed class HeadlineManager : UniqueDataManager<Domain, Update>
{
    public HeadlineManager(IOptions<JsonOptions> json)
        : base(json)
    {
    }
    ...
    {
        dto.AddValidator(new StringLengthAttribute(100) { MinimumLength = 1 });
    }
}
